...
class TestUsersEndpoints:
    ...
    def test_create_user_invalid_email(self, client):
        ...
        response = client.post(
            "/users",
            data=json.dumps({"username": "testuser", "email": "invalid-email"}),
            content_type="application/json",
        )
    ...
    def test_update_user(self, client):
        ...
        create_response = client.post(
            "/users",
            data=json.dumps({"username": "oldname", "email": "old@example.com"}),
            content_type="application/json",
        )
        user_data = json.loads(create_response.data)
        user_id = user_data["user_id"]
        ...
        response = client.put(
            f"/users/{user_id}",
            data=json.dumps({"username": "newname", "email": "new@example.com"}),
            content_type="application/json",
        )
